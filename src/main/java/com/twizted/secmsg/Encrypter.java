...
public class Encrypter
{
            ...
            IllegalBlockSizeException, BadPaddingException, NoSuchProviderException
    {
        ...
        encryptedString = new String(Base64.encodeToString(encryptedByte, Base64.DEFAULT));

        return encryptedString;
    }

    public String encrypt(String plainText, PrivateKey privatecKey) throws NoSuchAlgorithmException,
            NoSuchPaddingException, InvalidKeyException,
            IllegalBlockSizeException, BadPaddingException, NoSuchProviderException
    {
        cipherOne = Cipher.getInstance("RSA/ECB/PKCS1Padding", "AndroidOpenSSL");
        cipherOne.init(Cipher.ENCRYPT_MODE, privatecKey);
            ...
            IllegalBlockSizeException, BadPaddingException, NoSuchProviderException
    {
        ...
        decryptedByte = cipherTwo.doFinal(Base64.decode(cipherText, Base64.DEFAULT));
    ...
    public String decrypt(String cipherText, PublicKey publicKey) throws NoSuchAlgorithmException,
            NoSuchPaddingException, InvalidKeyException,
            IllegalBlockSizeException, BadPaddingException, NoSuchProviderException
    {
        cipherTwo = Cipher.getInstance("RSA/ECB/PKCS1Padding", "AndroidOpenSSL");
        cipherTwo.init(Cipher.DECRYPT_MODE, publicKey);
